...
def parse_args(args):
  ...
  parser.add_argument(
    "--version",
    action="version",
    version="cellexport {ver}".format(ver=__version__))
  ...
  parser.add_argument(
    ...
    help="Factor to downsample data. Default: 1 (no downsampling). A factor of 100 will keep only one value every 100.")
